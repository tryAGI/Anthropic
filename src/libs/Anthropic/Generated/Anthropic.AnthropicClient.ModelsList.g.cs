            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Anthropic.ListResponseModelInfo.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Anthropic.ListResponseModelInfo.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
