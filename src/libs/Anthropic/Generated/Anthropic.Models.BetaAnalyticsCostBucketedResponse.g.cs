...
namespace Anthropic
{
    ...
    public sealed partial class BetaAnalyticsCostBucketedResponse
    {
        ...
        public required global::System.Collections.Generic.IList<global::Anthropic.BetaAnalyticsCostReportTimeBucket> Data { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BetaAnalyticsCostBucketedResponse" /> class.
        /// </summary>
        /// <param name="data">
        /// Time buckets for this page, oldest first: one per `bucket_width` interval, including intervals with no data (their `results` list is empty). A page holds at most `limit` buckets.
        /// </param>
...
#endif
        public BetaAnalyticsCostBucketedResponse(
            global::System.Collections.Generic.IList<global::Anthropic.BetaAnalyticsCostReportTimeBucket> data,
            bool hasMore,
