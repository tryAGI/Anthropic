                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Anthropic.BetaManagedAgentsDeleteSessionResource.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Anthropic.BetaManagedAgentsDeleteSessionResource.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
