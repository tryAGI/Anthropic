...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaGetCurrentOrganizationV1OrganizationsMeGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xApiKey,
            ref string? anthropicVersion);
        partial void PrepareBetaGetCurrentOrganizationV1OrganizationsMeGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xApiKey,
            string? anthropicVersion);
        partial void ProcessBetaGetCurrentOrganizationV1OrganizationsMeGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaGetCurrentOrganizationV1OrganizationsMeGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Current Organization<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaOrganizationSchema> BetaGetCurrentOrganizationV1OrganizationsMeGetAsync(
            string? xApiKey = default,
            string? anthropicVersion = default,
            global::Anthropic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await BetaGetCurrentOrganizationV1OrganizationsMeGetAsResponseAsync(
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaOrganizationSchema>> BetaGetCurrentOrganizationV1OrganizationsMeGetAsResponseAsync(
            string? xApiKey = default,
            string? anthropicVersion = default,
            global::Anthropic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaGetCurrentOrganizationV1OrganizationsMeGetArguments(
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaGetCurrentOrganizationV1OrganizationsMeGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaGetCurrentOrganizationV1OrganizationsMeGet",
                                methodName: "BetaGetCurrentOrganizationV1OrganizationsMeGetAsync",
                                pathTemplate: "\"/v1/organizations/me?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaGetCurrentOrganizationV1OrganizationsMeGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaGetCurrentOrganizationV1OrganizationsMeGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaOrganizationSchema.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaOrganizationSchema>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaOrganizationSchema.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
