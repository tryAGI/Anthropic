...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string inviteId,
            ref string? xApiKey,
            ref string? anthropicVersion);
        partial void PrepareBetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string inviteId,
            string? xApiKey,
            string? anthropicVersion);
        partial void ProcessBetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaDeleteInviteResponse> BetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteAsync(
            string inviteId,
        ...
        {
            var __response = await BetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteAsResponseAsync(
                inviteId: inviteId,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaDeleteInviteResponse>> BetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteAsResponseAsync(
            string inviteId,
            string? xApiKey = default,
            string? anthropicVersion = default,
            global::Anthropic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/organizations/invites/{inviteId}?beta=true",
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaDeleteInviteV1OrganizationsInvitesInviteIdDelete",
                                methodName: "BetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteAsync",
                                pathTemplate: "$\"/v1/organizations/invites/{inviteId}?beta=true\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaDeleteInviteV1OrganizationsInvitesInviteIdDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaDeleteInviteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaDeleteInviteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaDeleteInviteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
