...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaListAgentVersionsArguments(
            ...
            ref int? limit,
            ref string? page);
        partial void PrepareBetaListAgentVersionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? page);
        partial void ProcessBetaListAgentVersionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaListAgentVersionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaManagedAgentsListAgentVersions> BetaListAgentVersionsAsync(
            string agentId,
        ...
        {
            var __response = await BetaListAgentVersionsAsResponseAsync(
                agentId: agentId,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaManagedAgentsListAgentVersions>> BetaListAgentVersionsAsResponseAsync(
            string agentId,
            string? xApiKey = default,
            string? anthropicVersion = default,
            string? anthropicBeta = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaListAgentVersionsArguments(
            ...
            if (anthropicBeta != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaListAgentVersionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaListAgentVersionsAsync",
                                pathTemplate: "$\"/v1/agents/{agentId}/versions?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaListAgentVersionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaListAgentVersionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaManagedAgentsListAgentVersions.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaManagedAgentsListAgentVersions>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaManagedAgentsListAgentVersions.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps BetaListAgentVersionsAsync as an IAsyncEnumerable&lt;global::Anthropic.BetaManagedAgentsAgent&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="xApiKey"></param>
        /// <param name="anthropicVersion"></param>
        /// <param name="anthropicBeta"></param>
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.BetaManagedAgentsAgent> BetaListAgentVersionsAutoPagingAsync(
            string agentId,             string? xApiKey = default,
            string? anthropicVersion = default,
            string? anthropicBeta = default,
            int? limit = default,
            string? page = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.BetaManagedAgentsListAgentVersions, global::Anthropic.BetaManagedAgentsAgent>(
                fetchPage: (__cursor, __ct) => BetaListAgentVersionsAsync(
                    xApiKey: xApiKey,
                    anthropicVersion: anthropicVersion,
                    anthropicBeta: anthropicBeta,
                    agentId: agentId,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.BetaManagedAgentsAgent>?)__response.Data,
