...
namespace Anthropic
{
    ...
    {
        partial void PrepareListSkillsV1SkillsGetArguments(
        ...
        partial void PrepareListSkillsV1SkillsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessListSkillsV1SkillsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListSkillsV1SkillsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.ListSkillsResponse> ListSkillsV1SkillsGetAsync(
            string? page = default,
            int? limit = default,
        ...
        {
            var __response = await ListSkillsV1SkillsGetAsResponseAsync(
                page: page,
                limit: limit,
                source: source,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.ListSkillsResponse>> ListSkillsV1SkillsGetAsResponseAsync(
            string? page = default,
            int? limit = default,
            string? source = default,
            string? anthropicVersion = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListSkillsV1SkillsGetArguments(
            ...
            if (anthropicWorkspaceId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListSkillsV1SkillsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListSkillsV1SkillsGet",
                                methodName: "ListSkillsV1SkillsGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListSkillsV1SkillsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListSkillsV1SkillsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.ListSkillsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.ListSkillsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.ListSkillsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps ListSkillsV1SkillsGetAsync as an IAsyncEnumerable&lt;global::Anthropic.Skill&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="limit">
        /// Number of results to return per page.<br/>
        /// Ranges from `1` to `1000`. Defaults to `20`.<br/>
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.Skill> ListSkillsV1SkillsGetAutoPagingAsync(
              int? limit = default,
            string? source = default,
            string? anthropicVersion = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.ListSkillsResponse, global::Anthropic.Skill>(
                fetchPage: (__cursor, __ct) => ListSkillsV1SkillsGetAsync(
                    page: __cursor,
                    limit: limit,
                    source: source,
                    anthropicVersion: anthropicVersion,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.Skill>?)__response.Data,
