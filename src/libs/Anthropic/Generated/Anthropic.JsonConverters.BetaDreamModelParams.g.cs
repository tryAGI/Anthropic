...
{
    /// <inheritdoc />
    public class BetaDreamModelParamsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.BetaDreamModelParams>
    {
        /// <inheritdoc />
        public override global::Anthropic.BetaDreamModelParams Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            string? betaDreamModelParamsVariant1 = default;
            global::Anthropic.BetaDreamModelConfigParams? config = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        betaDreamModelParamsVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (betaDreamModelParamsVariant1 == null && config == null)
            {
                try
                {
            ...
            var __value = new global::Anthropic.BetaDreamModelParams(
        ...
        public override void Write(
            ...
            global::Anthropic.BetaDreamModelParams value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsBetaDreamModelParamsVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
