...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostArguments(
        ...
        partial void PrepareBetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Anthropic.BetaSelfHostedWorkUpdateRequest request);
        partial void ProcessBetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaSelfHostedWork> BetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostAsync(
            string environmentId,
            string workId,
        ...
        {
            var __response = await BetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaSelfHostedWork>> BetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostAsResponseAsync(
            string environmentId,
            string workId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/environments/{environmentId}/work/{workId}?beta=true",
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPost",
                                methodName: "BetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostAsync",
                                pathTemplate: "$\"/v1/environments/{environmentId}/work/{workId}?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaSelfHostedWork> BetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaSelfHostedWorkUpdateRequest
            {
                Metadata = metadata,
            };

            return await BetaUpdateWorkV1EnvironmentsEnvironmentIdWorkWorkIdPostAsync(
                environmentId: environmentId,
                workId: workId,
                anthropicBeta: anthropicBeta,
                anthropicVersion: anthropicVersion,
