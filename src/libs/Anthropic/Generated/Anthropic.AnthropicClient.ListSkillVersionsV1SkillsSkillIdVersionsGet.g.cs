...
namespace Anthropic
{
    ...
    {
        partial void PrepareListSkillVersionsV1SkillsSkillIdVersionsGetArguments(
        ...
        partial void PrepareListSkillVersionsV1SkillsSkillIdVersionsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessListSkillVersionsV1SkillsSkillIdVersionsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListSkillVersionsV1SkillsSkillIdVersionsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.ListSkillVersionsResponse> ListSkillVersionsV1SkillsSkillIdVersionsGetAsync(
            string skillId,
            string? page = default,
            int? limit = default,
        ...
        {
            var __response = await ListSkillVersionsV1SkillsSkillIdVersionsGetAsResponseAsync(
                skillId: skillId,
                page: page,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.ListSkillVersionsResponse>> ListSkillVersionsV1SkillsSkillIdVersionsGetAsResponseAsync(
            string skillId,
            string? page = default,
            int? limit = default,
            string? anthropicVersion = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListSkillVersionsV1SkillsSkillIdVersionsGetArguments(
            ...
            if (anthropicWorkspaceId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListSkillVersionsV1SkillsSkillIdVersionsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListSkillVersionsV1SkillsSkillIdVersionsGet",
                                methodName: "ListSkillVersionsV1SkillsSkillIdVersionsGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListSkillVersionsV1SkillsSkillIdVersionsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Anthropic.ErrorResponse? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Anthropic.ErrorResponse.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListSkillVersionsV1SkillsSkillIdVersionsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.ListSkillVersionsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.ListSkillVersionsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.ListSkillVersionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps ListSkillVersionsV1SkillsSkillIdVersionsGetAsync as an IAsyncEnumerable&lt;global::Anthropic.SkillVersion&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="skillId">
        /// Unique identifier for the skill.<br/>
        /// The format and length of IDs may change over time.
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.SkillVersion> ListSkillVersionsV1SkillsSkillIdVersionsGetAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.ListSkillVersionsResponse, global::Anthropic.SkillVersion>(
                fetchPage: (__cursor, __ct) => ListSkillVersionsV1SkillsSkillIdVersionsGetAsync(
                    skillId: skillId,
                    page: __cursor,
                    limit: limit,
                    anthropicVersion: anthropicVersion,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.SkillVersion>?)__response.Data,
