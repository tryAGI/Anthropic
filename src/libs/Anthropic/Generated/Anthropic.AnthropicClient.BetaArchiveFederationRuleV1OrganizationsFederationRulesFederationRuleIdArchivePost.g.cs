...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        partial void ProcessBetaArchiveFederationRuleV1OrganizationsFederationRulesFederationRuleIdArchivePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await BetaArchiveFederationRuleV1OrganizationsFederationRulesFederationRuleIdArchivePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/organizations/federation_rules/{federationRuleId}/archive?beta=true",
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaArchiveFederationRuleV1OrganizationsFederationRulesFederationRuleIdArchivePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaArchiveFederationRuleV1OrganizationsFederationRulesFederationRuleIdArchivePost",
                                methodName: "BetaArchiveFederationRuleV1OrganizationsFederationRulesFederationRuleIdArchivePostAsync",
                                pathTemplate: "$\"/v1/organizations/federation_rules/{federationRuleId}/archive?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaArchiveFederationRuleV1OrganizationsFederationRulesFederationRuleIdArchivePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaArchiveFederationRuleV1OrganizationsFederationRulesFederationRuleIdArchivePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
