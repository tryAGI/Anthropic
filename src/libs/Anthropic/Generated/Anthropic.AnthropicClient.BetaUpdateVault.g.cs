...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        partial void PrepareBetaUpdateVaultRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string vaultId,
            global::Anthropic.BetaManagedAgentsUpdateVaultRequestBody request);
        partial void ProcessBetaUpdateVaultResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaUpdateVaultResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await BetaUpdateVaultAsResponseAsync(
                vaultId: vaultId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaManagedAgentsVault>> BetaUpdateVaultAsResponseAsync(
            string vaultId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaUpdateVaultAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateVaultResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateVaultResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaManagedAgentsVault> BetaUpdateVaultAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaManagedAgentsUpdateVaultRequestBody
            {
                DisplayName = displayName,
                Metadata = metadata,
            };

            return await BetaUpdateVaultAsync(
                anthropicVersion: anthropicVersion,
                anthropicBeta: anthropicBeta,
                vaultId: vaultId,
                request: __request,
