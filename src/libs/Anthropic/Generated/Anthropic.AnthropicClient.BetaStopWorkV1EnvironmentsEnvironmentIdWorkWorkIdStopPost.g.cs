...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostArguments(
        ...
        partial void PrepareBetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Anthropic.BetaSelfHostedWorkStopRequest request);
        partial void ProcessBetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaSelfHostedWork> BetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostAsync(
            string environmentId,
            string workId,
        ...
        {
            var __response = await BetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaSelfHostedWork>> BetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostAsResponseAsync(
            string environmentId,
            string workId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/environments/{environmentId}/work/{workId}/stop?beta=true",
            ...
            if (authorization != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPost",
                                methodName: "BetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostAsync",
                                pathTemplate: "$\"/v1/environments/{environmentId}/work/{workId}/stop?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaSelfHostedWork.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaSelfHostedWork>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaSelfHostedWork.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaSelfHostedWork> BetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaSelfHostedWorkStopRequest
            {
                Force = force,
            };

            return await BetaStopWorkV1EnvironmentsEnvironmentIdWorkWorkIdStopPostAsync(
                environmentId: environmentId,
                workId: workId,
                anthropicBeta: anthropicBeta,
                anthropicVersion: anthropicVersion,
