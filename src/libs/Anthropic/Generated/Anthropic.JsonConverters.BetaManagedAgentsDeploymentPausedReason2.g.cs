...
{
    /// <inheritdoc />
    public class BetaManagedAgentsDeploymentPausedReason2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.BetaManagedAgentsDeploymentPausedReason2>
    {
        /// <inheritdoc />
        public override global::Anthropic.BetaManagedAgentsDeploymentPausedReason2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __value = new global::Anthropic.BetaManagedAgentsDeploymentPausedReason2(
                discriminator?.Type,
                manual,
        ...
        public override void Write(
            ...
            global::Anthropic.BetaManagedAgentsDeploymentPausedReason2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
