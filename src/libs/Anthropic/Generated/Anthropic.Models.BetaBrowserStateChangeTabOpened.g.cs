...
namespace Anthropic
{
    ...
    public sealed partial class BetaBrowserStateChangeTabOpened
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BetaBrowserStateChangeTabOpened" /> class.
        /// </summary>
        /// <param name="tabId">
        /// The `tab_id` of the opened tab, present in `tabs`.
        /// </param>
        ...
        /// <summary>
        /// Creates a new <see cref="BetaBrowserStateChangeTabOpened"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static BetaBrowserStateChangeTabOpened FromTabId(string tabId)
        {
            return new BetaBrowserStateChangeTabOpened
            {
                TabId = tabId,
            };
        }
