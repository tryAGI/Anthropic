...
{
    /// <inheritdoc />
    public class Caller3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.Caller3>
    {
        /// <inheritdoc />
        public override global::Anthropic.Caller3 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaRequestWebFetchToolResultBlockCallerDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaRequestWebFetchToolResultBlockCallerDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaRequestWebFetchToolResultBlockCallerDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.BetaDirectCaller? direct = default;
            if (discriminator?.Type == global::Anthropic.BetaRequestWebFetchToolResultBlockCallerDiscriminatorType.Direct)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaRequestWebFetchToolResultBlockCallerDiscriminatorType.CodeExecution20250825)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaRequestWebFetchToolResultBlockCallerDiscriminatorType.CodeExecution20260120)
            {
            ...
            var __value = new global::Anthropic.Caller3(
                discriminator?.Type,
                direct,
        ...
        public override void Write(
            ...
            global::Anthropic.Caller3 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
