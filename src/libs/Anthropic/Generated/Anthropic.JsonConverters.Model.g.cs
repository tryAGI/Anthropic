...
namespace Anthropic.JsonConverters
{
    ...
    public class ModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.Model>
    {
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 14)
                {
                    try
                    {
                        ...
                        modelVariant15 = global::System.Text.Json.JsonSerializer.Deserialize<string>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 15)
                {
                    try
                    {
                        ...
                        modelVariant16 = global::System.Text.Json.JsonSerializer.Deserialize<string>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ModelVariant15, typeof(string), options);
            }
            else if (value.IsModelVariant16)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ModelVariant16, typeof(string), options);
            }
        }
    }
}