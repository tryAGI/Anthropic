...
namespace Anthropic
{
    ...
    {
        partial void PrepareGetFileMetadataV1FilesFileIdGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string fileId,
            ref string? anthropicVersion,
            ref string? xApiKey,
            ref string? anthropicWorkspaceId);
        partial void PrepareGetFileMetadataV1FilesFileIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetFileMetadataV1FilesFileIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFileMetadataV1FilesFileIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.FileMetadataSchema> GetFileMetadataV1FilesFileIdGetAsync(
            string fileId,
        ...
        {
            var __response = await GetFileMetadataV1FilesFileIdGetAsResponseAsync(
                fileId: fileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.FileMetadataSchema>> GetFileMetadataV1FilesFileIdGetAsResponseAsync(
            string fileId,
            string? anthropicVersion = default,
            string? xApiKey = default,
            string? anthropicWorkspaceId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFileMetadataV1FilesFileIdGetArguments(
            ...
            if (anthropicWorkspaceId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFileMetadataV1FilesFileIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetFileMetadataV1FilesFileIdGet",
                                methodName: "GetFileMetadataV1FilesFileIdGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFileMetadataV1FilesFileIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFileMetadataV1FilesFileIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
