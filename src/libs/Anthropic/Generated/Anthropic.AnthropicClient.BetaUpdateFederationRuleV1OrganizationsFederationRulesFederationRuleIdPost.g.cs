...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        partial void ProcessBetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await BetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaFederationRule>> BetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostAsResponseAsync(
            string federationRuleId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/organizations/federation_rules/{federationRuleId}?beta=true",
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPost",
                                methodName: "BetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostAsync",
                                pathTemplate: "$\"/v1/organizations/federation_rules/{federationRuleId}?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaFederationRule> BetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaFederationRuleUpdateParams
            {
            ...
            return await BetaUpdateFederationRuleV1OrganizationsFederationRulesFederationRuleIdPostAsync(
                federationRuleId: federationRuleId,
                anthropicBeta: anthropicBeta,
                anthropicVersion: anthropicVersion,
                request: __request,
