...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaRotateTunnelTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? anthropicVersion,
            ref string? anthropicBeta,
            ref string tunnelId,
            global::Anthropic.BetaRotateTunnelTokenRequestBody request);
        partial void PrepareBetaRotateTunnelTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string tunnelId,
            global::Anthropic.BetaRotateTunnelTokenRequestBody request);
        partial void ProcessBetaRotateTunnelTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaRotateTunnelTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaTunnelToken> BetaRotateTunnelTokenAsync(
            string tunnelId,
        ...
        {
            var __response = await BetaRotateTunnelTokenAsResponseAsync(
                tunnelId: tunnelId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaTunnelToken>> BetaRotateTunnelTokenAsResponseAsync(
            string tunnelId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBetaRotateTunnelTokenArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/tunnels/{tunnelId}/rotate_token?beta=true",
            ...
            if (anthropicBeta != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaRotateTunnelTokenRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaRotateTunnelTokenAsync",
                                pathTemplate: "$\"/v1/tunnels/{tunnelId}/rotate_token?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaRotateTunnelTokenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaRotateTunnelTokenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaTunnelToken.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaTunnelToken>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaTunnelToken.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaTunnelToken> BetaRotateTunnelTokenAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaRotateTunnelTokenRequestBody
            {
                Reason = reason,
            };

            return await BetaRotateTunnelTokenAsync(
                anthropicVersion: anthropicVersion,
                anthropicBeta: anthropicBeta,
                tunnelId: tunnelId,
                request: __request,
