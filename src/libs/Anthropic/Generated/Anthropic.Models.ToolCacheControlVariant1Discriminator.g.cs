...
namespace Anthropic
{
    ...
    public sealed partial class ToolCacheControlVariant1Discriminator
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Anthropic.JsonConverters.ToolCacheControlVariant1DiscriminatorTypeJsonConverter))]
        public global::Anthropic.ToolCacheControlVariant1DiscriminatorType? Type { get; set; }
