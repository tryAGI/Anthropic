...
namespace Anthropic
{
    ...
    public sealed partial class BetaResponseToolReferenceBlock
    {
        ...
        /// <summary>
        /// Creates a new <see cref="BetaResponseToolReferenceBlock"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static BetaResponseToolReferenceBlock FromToolName(string toolName)
        {
            return new BetaResponseToolReferenceBlock
            {
                ToolName = toolName,
            };
        }
