...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        partial void ProcessBetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await BetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaServiceAccount>> BetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostAsResponseAsync(
            string serviceAccountId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPost",
                                methodName: "BetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaServiceAccount> BetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaServiceAccountUpdateParams
            {
                Description = description,
                OrganizationRole = organizationRole,
            };

            return await BetaUpdateServiceAccountV1OrganizationsServiceAccountsServiceAccountIdPostAsync(
                serviceAccountId: serviceAccountId,
                anthropicBeta: anthropicBeta,
                anthropicVersion: anthropicVersion,
                request: __request,
