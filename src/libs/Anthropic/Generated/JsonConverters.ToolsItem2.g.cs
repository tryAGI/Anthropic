...
{
    /// <inheritdoc />
    public class ToolsItem2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.ToolsItem2>
    {
        /// <inheritdoc />
        public override global::Anthropic.ToolsItem2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaCreateMessageParamsToolDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaCreateMessageParamsToolDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaCreateMessageParamsToolDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.BetaTool? custom = default;
            if (discriminator?.Type == global::Anthropic.BetaCreateMessageParamsToolDiscriminatorType.Custom)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaCreateMessageParamsToolDiscriminatorType.Computer20241022)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaCreateMessageParamsToolDiscriminatorType.Bash20241022)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaCreateMessageParamsToolDiscriminatorType.TextEditor20241022)
            {
        ...
        public override void Write(
            ...
            global::Anthropic.ToolsItem2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
