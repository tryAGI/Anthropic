...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        partial void PrepareBetaUpdateCredentialRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string credentialId,
            global::Anthropic.BetaManagedAgentsUpdateCredentialRequestBody request);
        partial void ProcessBetaUpdateCredentialResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaUpdateCredentialResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaManagedAgentsCredential> BetaUpdateCredentialAsync(
            string vaultId,
            string credentialId,
        ...
        {
            var __response = await BetaUpdateCredentialAsResponseAsync(
                vaultId: vaultId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaManagedAgentsCredential>> BetaUpdateCredentialAsResponseAsync(
            string vaultId,
            string credentialId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (anthropicBeta != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaUpdateCredentialRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaUpdateCredentialAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateCredentialResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateCredentialResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaManagedAgentsCredential> BetaUpdateCredentialAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaManagedAgentsUpdateCredentialRequestBody
            {
            ...
            return await BetaUpdateCredentialAsync(
                anthropicVersion: anthropicVersion,
                anthropicBeta: anthropicBeta,
                vaultId: vaultId,
                credentialId: credentialId,
