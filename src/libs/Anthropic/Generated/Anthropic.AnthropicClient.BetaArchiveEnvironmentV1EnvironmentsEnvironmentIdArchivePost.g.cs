...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string environmentId,
            ref string? anthropicBeta,
            ref string? anthropicVersion);
        partial void PrepareBetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string environmentId,
            string? anthropicBeta,
            string? anthropicVersion);
        partial void ProcessBetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaEnvironment> BetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostAsync(
            string environmentId,
        ...
        {
            var __response = await BetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaEnvironment>> BetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostAsResponseAsync(
            string environmentId,
            string? anthropicBeta = default,
            string? anthropicVersion = default,
            global::Anthropic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostArguments(
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePost",
                                methodName: "BetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostAsync",
                                pathTemplate: "$\"/v1/environments/{environmentId}/archive?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaArchiveEnvironmentV1EnvironmentsEnvironmentIdArchivePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaEnvironment.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaEnvironment>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaEnvironment.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
