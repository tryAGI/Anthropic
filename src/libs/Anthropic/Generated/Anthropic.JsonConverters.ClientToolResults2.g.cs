...
{
    /// <inheritdoc />
    public class ClientToolResults2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.ClientToolResults2>
    {
        /// <inheritdoc />
        public override global::Anthropic.ClientToolResults2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.WebFetchUrlSourcesClientToolResultsDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.WebFetchUrlSourcesClientToolResultsDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.WebFetchUrlSourcesClientToolResultsDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.WebFetchUrlSourceAll? all = default;
            if (discriminator?.Type == global::Anthropic.WebFetchUrlSourcesClientToolResultsDiscriminatorType.All)
            {
            ...
            if (discriminator?.Type == global::Anthropic.WebFetchUrlSourcesClientToolResultsDiscriminatorType.None)
            {
            ...
            global::Anthropic.WebFetchUrlSourceOnly? only = default;
            if (discriminator?.Type == global::Anthropic.WebFetchUrlSourcesClientToolResultsDiscriminatorType.Only)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.WebFetchUrlSourceOnly), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.WebFetchUrlSourceOnly> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.WebFetchUrlSourceOnly)}");
                only = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }
            global::Anthropic.WebFetchUrlSourceExcept? except = default;
            if (discriminator?.Type == global::Anthropic.WebFetchUrlSourcesClientToolResultsDiscriminatorType.Except)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.WebFetchUrlSourceExcept), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.WebFetchUrlSourceExcept> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.WebFetchUrlSourceExcept)}");
                except = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }

            var __value = new global::Anthropic.ClientToolResults2(
                discriminator?.Type,
                all,
        ...
        public override void Write(
            ...
            global::Anthropic.ClientToolResults2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
