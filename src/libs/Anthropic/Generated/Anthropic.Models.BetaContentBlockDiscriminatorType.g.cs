...
namespace Anthropic
{
    ...
    public static class BetaContentBlockDiscriminatorTypeExtensions
    {
        ...
        public static string ToValueString(this BetaContentBlockDiscriminatorType value)
        {
            return value switch
            {
                BetaContentBlockDiscriminatorType.AdvisorToolResult => "advisor_tool_result",
                ...
                BetaContentBlockDiscriminatorType.Compaction => "compaction",
                BetaContentBlockDiscriminatorType.ContainerUpload => "container_upload",
                BetaContentBlockDiscriminatorType.Fallback => "fallback",
                BetaContentBlockDiscriminatorType.McpToolListing => "mcp_tool_listing",
                ...
                BetaContentBlockDiscriminatorType.ToolSearchToolResult => "tool_search_tool_result",
        ...
        public static BetaContentBlockDiscriminatorType? ToEnum(string value)
        {
            return value switch
            {
                "advisor_tool_result" => BetaContentBlockDiscriminatorType.AdvisorToolResult,
                ...
                "compaction" => BetaContentBlockDiscriminatorType.Compaction,
                "container_upload" => BetaContentBlockDiscriminatorType.ContainerUpload,
                "fallback" => BetaContentBlockDiscriminatorType.Fallback,
                "mcp_tool_listing" => BetaContentBlockDiscriminatorType.McpToolListing,
                ...
                "tool_search_tool_result" => BetaContentBlockDiscriminatorType.ToolSearchToolResult,
