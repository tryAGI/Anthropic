...
namespace Anthropic
{
    ...
    {
        partial void PrepareDownloadFileV1FilesFileIdContentGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string fileId,
            ref string? anthropicVersion,
            ref string? xApiKey);
        partial void PrepareDownloadFileV1FilesFileIdContentGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string fileId,
            string? anthropicVersion,
            string? xApiKey);
        partial void ProcessDownloadFileV1FilesFileIdContentGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDownloadFileV1FilesFileIdContentGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> DownloadFileV1FilesFileIdContentGetAsync(
            string fileId,
        ...
        {
            var __response = await DownloadFileV1FilesFileIdContentGetAsResponseAsync(
                fileId: fileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> DownloadFileV1FilesFileIdContentGetAsStreamAsync(
            string fileId,
            string? anthropicVersion = default,
            string? xApiKey = default,
            global::Anthropic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDownloadFileV1FilesFileIdContentGetArguments(
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDownloadFileV1FilesFileIdContentGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DownloadFileV1FilesFileIdContentGet",
                                methodName: "DownloadFileV1FilesFileIdContentGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDownloadFileV1FilesFileIdContentGetResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<byte[]>> DownloadFileV1FilesFileIdContentGetAsResponseAsync(
            string fileId,
            string? anthropicVersion = default,
            string? xApiKey = default,
            global::Anthropic.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDownloadFileV1FilesFileIdContentGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
