...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaListWorkV1EnvironmentsEnvironmentIdWorkGetArguments(
        ...
        partial void ProcessBetaListWorkV1EnvironmentsEnvironmentIdWorkGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaSelfHostedWorkListResponse> BetaListWorkV1EnvironmentsEnvironmentIdWorkGetAsync(
            string environmentId,
            int? limit = default,
            string? page = default,
        ...
        {
            var __response = await BetaListWorkV1EnvironmentsEnvironmentIdWorkGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaSelfHostedWorkListResponse>> BetaListWorkV1EnvironmentsEnvironmentIdWorkGetAsResponseAsync(
            string environmentId,
            int? limit = default,
            string? page = default,
            string? anthropicBeta = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaListWorkV1EnvironmentsEnvironmentIdWorkGetArguments(
            ...
            if (authorization != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaListWorkV1EnvironmentsEnvironmentIdWorkGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaListWorkV1EnvironmentsEnvironmentIdWorkGet",
                                methodName: "BetaListWorkV1EnvironmentsEnvironmentIdWorkGetAsync",
                                pathTemplate: "$\"/v1/environments/{environmentId}/work?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaListWorkV1EnvironmentsEnvironmentIdWorkGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaListWorkV1EnvironmentsEnvironmentIdWorkGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaSelfHostedWorkListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaSelfHostedWorkListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaSelfHostedWorkListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.BetaSelfHostedWork> BetaListWorkV1EnvironmentsEnvironmentIdWorkGetAutoPagingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.BetaSelfHostedWorkListResponse, global::Anthropic.BetaSelfHostedWork>(
                fetchPage: (__cursor, __ct) => BetaListWorkV1EnvironmentsEnvironmentIdWorkGetAsync(
                    environmentId: environmentId,
                    limit: limit,
                    page: __cursor,
                    anthropicBeta: anthropicBeta,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.BetaSelfHostedWork>?)__response.Data,
