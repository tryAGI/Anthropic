...
{
    /// <inheritdoc />
    public class CacheControlVariant190JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.CacheControlVariant190>
    {
        /// <inheritdoc />
        public override global::Anthropic.CacheControlVariant190 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __value = new global::Anthropic.CacheControlVariant190(
                discriminator?.Type,
                ephemeral
                );
        ...
        public override void Write(
            ...
            global::Anthropic.CacheControlVariant190 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
