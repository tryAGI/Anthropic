            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("workspace_ids[]", workspaceIds, delimiter: ",", explode: true)
                                .AddOptionalParameter("account_ids[]", accountIds, delimiter: ",", explode: true)
                                .AddOptionalParameter("service_account_ids[]", serviceAccountIds, delimiter: ",", explode: true)
                                .AddOptionalParameter("models[]", models, delimiter: ",", explode: true)
                                .AddOptionalParameter("service_tiers[]", serviceTiers, selector: static x => x.ToValueString(), delimiter: ",", explode: true)
                                .AddOptionalParameter("context_window[]", contextWindow, selector: static x => x.ToValueString(), delimiter: ",", explode: true)
