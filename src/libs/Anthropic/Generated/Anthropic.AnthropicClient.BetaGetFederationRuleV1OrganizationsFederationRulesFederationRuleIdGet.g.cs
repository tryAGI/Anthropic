...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        partial void ProcessBetaGetFederationRuleV1OrganizationsFederationRulesFederationRuleIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Federation Rule<br/>
        ...
        {
            var __response = await BetaGetFederationRuleV1OrganizationsFederationRulesFederationRuleIdGetAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaGetFederationRuleV1OrganizationsFederationRulesFederationRuleIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaGetFederationRuleV1OrganizationsFederationRulesFederationRuleIdGet",
                                methodName: "BetaGetFederationRuleV1OrganizationsFederationRulesFederationRuleIdGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaGetFederationRuleV1OrganizationsFederationRulesFederationRuleIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaGetFederationRuleV1OrganizationsFederationRulesFederationRuleIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
