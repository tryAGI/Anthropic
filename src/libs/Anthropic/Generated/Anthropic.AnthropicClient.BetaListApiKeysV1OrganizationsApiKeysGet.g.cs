...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaListApiKeysV1OrganizationsApiKeysGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? beforeId,
            ref string? afterId,
            ref int? limit,
            ref global::Anthropic.BetaListApiKeysV1OrganizationsApiKeysGetStatus? status,
            ref string? workspaceId,
            ref string? createdByUserId,
            ref string? xApiKey,
            ref string? anthropicVersion);
        partial void PrepareBetaListApiKeysV1OrganizationsApiKeysGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? beforeId,
            string? afterId,
            int? limit,
            global::Anthropic.BetaListApiKeysV1OrganizationsApiKeysGetStatus? status,
            string? workspaceId,
            string? createdByUserId,
            string? xApiKey,
            string? anthropicVersion);
        partial void ProcessBetaListApiKeysV1OrganizationsApiKeysGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaListApiKeysV1OrganizationsApiKeysGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaListResponseApiKey> BetaListApiKeysV1OrganizationsApiKeysGetAsync(
            string? beforeId = default,
            string? afterId = default,
            int? limit = default,
            global::Anthropic.BetaListApiKeysV1OrganizationsApiKeysGetStatus? status = default,
        ...
        {
            var __response = await BetaListApiKeysV1OrganizationsApiKeysGetAsResponseAsync(
                beforeId: beforeId,
                afterId: afterId,
                limit: limit,
                status: status,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaListResponseApiKey>> BetaListApiKeysV1OrganizationsApiKeysGetAsResponseAsync(
            string? beforeId = default,
            string? afterId = default,
            int? limit = default,
            global::Anthropic.BetaListApiKeysV1OrganizationsApiKeysGetStatus? status = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaListApiKeysV1OrganizationsApiKeysGetArguments(
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaListApiKeysV1OrganizationsApiKeysGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaListApiKeysV1OrganizationsApiKeysGet",
                                methodName: "BetaListApiKeysV1OrganizationsApiKeysGetAsync",
                                pathTemplate: "\"/v1/organizations/api_keys?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaListApiKeysV1OrganizationsApiKeysGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaListApiKeysV1OrganizationsApiKeysGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaListResponseApiKey.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaListResponseApiKey>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaListResponseApiKey.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.BetaApiKey> BetaListApiKeysV1OrganizationsApiKeysGetAutoPagingAsync(
              string? beforeId = default,
            int? limit = default,
            global::Anthropic.BetaListApiKeysV1OrganizationsApiKeysGetStatus? status = default,
            string? workspaceId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.BetaListResponseApiKey, global::Anthropic.BetaApiKey>(
                fetchPage: (__cursor, __ct) => BetaListApiKeysV1OrganizationsApiKeysGetAsync(
                    beforeId: beforeId,
                    afterId: __cursor,
                    limit: limit,
                    status: status,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.BetaApiKey>?)__response.Data,
