...
{
    /// <inheritdoc />
    public class BetaDreamingErrorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.BetaDreamingError>
    {
        /// <inheritdoc />
        public override global::Anthropic.BetaDreamingError Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaDreamingErrorDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaDreamingErrorDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaDreamingErrorDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.BetaInvalidRequestError? invalidRequestError = default;
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.InvalidRequestError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.AuthenticationError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.BillingError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.PermissionError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.NotFoundError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.RateLimitError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.TimeoutError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.ApiError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.OverloadedError)
            {
            ...
            global::Anthropic.BetaTargetStoreHeldError? conflictError = default;
            if (discriminator?.Type == global::Anthropic.BetaDreamingErrorDiscriminatorType.ConflictError)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaTargetStoreHeldError), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaTargetStoreHeldError> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaTargetStoreHeldError)}");
                conflictError = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }

            var __value = new global::Anthropic.BetaDreamingError(
                discriminator?.Type,
                invalidRequestError,
        ...
        public override void Write(
            ...
            global::Anthropic.BetaDreamingError value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaTargetStoreHeldError), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaTargetStoreHeldError?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Anthropic.BetaTargetStoreHeldError).Name}");
