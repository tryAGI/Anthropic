...
{
    /// <inheritdoc />
    public class BetaManagedAgentsEffortParamsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.BetaManagedAgentsEffortParams>
    {
        /// <inheritdoc />
        public override global::Anthropic.BetaManagedAgentsEffortParams Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaManagedAgentsEffortLevel), options);
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        level = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
        ...
        public override void Write(
            ...
            global::Anthropic.BetaManagedAgentsEffortParams value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
