...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaGetTunnelCertificateArguments(
        ...
        partial void PrepareBetaGetTunnelCertificateRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessBetaGetTunnelCertificateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaGetTunnelCertificateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Tunnel Certificate<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaTunnelCertificate> BetaGetTunnelCertificateAsync(
            string tunnelId,
            string certificateId,
        ...
        {
            var __response = await BetaGetTunnelCertificateAsResponseAsync(
                tunnelId: tunnelId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaTunnelCertificate>> BetaGetTunnelCertificateAsResponseAsync(
            string tunnelId,
            string certificateId,
            string? xApiKey = default,
            string? anthropicVersion = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaGetTunnelCertificateArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/tunnels/{tunnelId}/certificates/{certificateId}?beta=true",
            ...
            if (anthropicBeta != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaGetTunnelCertificateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaGetTunnelCertificateAsync",
                                pathTemplate: "$\"/v1/tunnels/{tunnelId}/certificates/{certificateId}?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaGetTunnelCertificateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaGetTunnelCertificateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
