...
namespace Anthropic
{
    ...
    {
        partial void PrepareDeleteSkillV1SkillsSkillIdDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string skillId,
            ref string? anthropicVersion,
            ref string? xApiKey,
            ref string? anthropicWorkspaceId);
        partial void PrepareDeleteSkillV1SkillsSkillIdDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessDeleteSkillV1SkillsSkillIdDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteSkillV1SkillsSkillIdDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.DeletedSkill> DeleteSkillV1SkillsSkillIdDeleteAsync(
            string skillId,
        ...
        {
            var __response = await DeleteSkillV1SkillsSkillIdDeleteAsResponseAsync(
                skillId: skillId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.DeletedSkill>> DeleteSkillV1SkillsSkillIdDeleteAsResponseAsync(
            string skillId,
            string? anthropicVersion = default,
            string? xApiKey = default,
            string? anthropicWorkspaceId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteSkillV1SkillsSkillIdDeleteArguments(
            ...
            if (anthropicWorkspaceId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteSkillV1SkillsSkillIdDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteSkillV1SkillsSkillIdDelete",
                                methodName: "DeleteSkillV1SkillsSkillIdDeleteAsync",
                                pathTemplate: "$\"/v1/skills/{skillId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteSkillV1SkillsSkillIdDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteSkillV1SkillsSkillIdDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.DeletedSkill.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.DeletedSkill>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.DeletedSkill.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
