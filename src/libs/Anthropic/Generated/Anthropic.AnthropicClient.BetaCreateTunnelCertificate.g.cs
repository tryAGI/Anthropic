...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaCreateTunnelCertificateArguments(
        ...
        partial void ProcessBetaCreateTunnelCertificateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaTunnelCertificate> BetaCreateTunnelCertificateAsync(
            string tunnelId,
        ...
        {
            var __response = await BetaCreateTunnelCertificateAsResponseAsync(
                tunnelId: tunnelId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaTunnelCertificate>> BetaCreateTunnelCertificateAsResponseAsync(
            string tunnelId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBetaCreateTunnelCertificateArguments(
            ...
            if (anthropicBeta != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaCreateTunnelCertificateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaCreateTunnelCertificateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaCreateTunnelCertificateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaCreateTunnelCertificateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaTunnelCertificate> BetaCreateTunnelCertificateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaCreateTunnelCertificateRequestBody
            {
                CaCertificatePem = caCertificatePem,
            };

            return await BetaCreateTunnelCertificateAsync(
                anthropicVersion: anthropicVersion,
                anthropicBeta: anthropicBeta,
                tunnelId: tunnelId,
                request: __request,
