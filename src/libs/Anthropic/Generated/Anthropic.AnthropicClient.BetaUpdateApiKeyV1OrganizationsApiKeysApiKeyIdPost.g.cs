...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string apiKeyId,
            ref string? anthropicVersion,
            global::Anthropic.BetaApiKeyUpdateParams request);
        partial void PrepareBetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string apiKeyId,
            string? anthropicVersion,
            global::Anthropic.BetaApiKeyUpdateParams request);
        partial void ProcessBetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaApiKey> BetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostAsync(
            string apiKeyId,
        ...
        {
            var __response = await BetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostAsResponseAsync(
                apiKeyId: apiKeyId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaApiKey>> BetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostAsResponseAsync(
            string apiKeyId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/organizations/api_keys/{apiKeyId}?beta=true",
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPost",
                                methodName: "BetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostAsync",
                                pathTemplate: "$\"/v1/organizations/api_keys/{apiKeyId}?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaApiKey.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaApiKey>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaApiKey.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaApiKey> BetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaApiKeyUpdateParams
            {
                Name = name,
                Status = status,
            };

            return await BetaUpdateApiKeyV1OrganizationsApiKeysApiKeyIdPostAsync(
                apiKeyId: apiKeyId,
                anthropicVersion: anthropicVersion,
                request: __request,
                requestOptions: requestOptions,
