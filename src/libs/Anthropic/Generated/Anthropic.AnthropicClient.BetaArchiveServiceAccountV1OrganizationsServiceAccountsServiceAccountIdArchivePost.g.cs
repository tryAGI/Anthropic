...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string serviceAccountId,
            ref string? anthropicBeta,
            ref string? anthropicVersion);
        partial void PrepareBetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string serviceAccountId,
            string? anthropicBeta,
            string? anthropicVersion);
        partial void ProcessBetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaServiceAccount> BetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostAsync(
            string serviceAccountId,
        ...
        {
            var __response = await BetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaServiceAccount>> BetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostAsResponseAsync(
            string serviceAccountId,
            string? anthropicBeta = default,
            string? anthropicVersion = default,
            global::Anthropic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/organizations/service_accounts/{serviceAccountId}/archive?beta=true",
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePost",
                                methodName: "BetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostAsync",
                                pathTemplate: "$\"/v1/organizations/service_accounts/{serviceAccountId}/archive?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaArchiveServiceAccountV1OrganizationsServiceAccountsServiceAccountIdArchivePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaServiceAccount.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaServiceAccount>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaServiceAccount.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
