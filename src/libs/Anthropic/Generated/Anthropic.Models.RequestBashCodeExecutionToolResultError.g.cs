...
namespace Anthropic
{
    ...
    public sealed partial class RequestBashCodeExecutionToolResultError
    {
        ...
        /// <summary>
        /// Creates a new <see cref="RequestBashCodeExecutionToolResultError"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static RequestBashCodeExecutionToolResultError FromErrorCode(global::Anthropic.BashCodeExecutionToolResultErrorCode errorCode)
        {
            return new RequestBashCodeExecutionToolResultError
            {
                ErrorCode = errorCode,
            };
        }
