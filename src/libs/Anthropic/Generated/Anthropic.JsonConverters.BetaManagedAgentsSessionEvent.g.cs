...
{
    /// <inheritdoc />
    public class BetaManagedAgentsSessionEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.BetaManagedAgentsSessionEvent>
    {
        /// <inheritdoc />
        public override global::Anthropic.BetaManagedAgentsSessionEvent Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaManagedAgentsSessionEventDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaManagedAgentsSessionEventDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaManagedAgentsSessionEventDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.BetaManagedAgentsUserMessageEvent? userMessage = default;
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.UserMessage)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.UserInterrupt)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.UserToolConfirmation)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.UserCustomToolResult)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentCustomToolUse)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentMessage)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentThinking)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentMcpToolUse)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentMcpToolResult)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentToolUse)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentToolResult)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentThreadMessageReceived)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentThreadMessageSent)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.AgentThreadContextCompacted)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionError)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionStatusRescheduled)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionStatusRunning)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionStatusIdle)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionStatusTerminated)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionThreadCreated)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SpanOutcomeEvaluationStart)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SpanOutcomeEvaluationEnd)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SpanModelRequestStart)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SpanModelRequestEnd)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SpanOutcomeEvaluationOngoing)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.UserDefineOutcome)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionDeleted)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionThreadStatusRunning)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionThreadStatusIdle)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionThreadStatusTerminated)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.UserToolResult)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionThreadStatusRescheduled)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionUpdated)
            {
            ...
            global::Anthropic.BetaManagedAgentsSystemMessageEvent? systemMessage = default;
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SystemMessage)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaManagedAgentsSystemMessageEvent), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaManagedAgentsSystemMessageEvent> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaManagedAgentsSystemMessageEvent)}");
                systemMessage = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }
            global::Anthropic.BetaManagedAgentsSessionUsageEvent? sessionUsage = default;
            if (discriminator?.Type == global::Anthropic.BetaManagedAgentsSessionEventDiscriminatorType.SessionUsage)
            {
            ...
            var __value = new global::Anthropic.BetaManagedAgentsSessionEvent(
                discriminator?.Type,
                userMessage,
        ...
        public override void Write(
            ...
            global::Anthropic.BetaManagedAgentsSessionEvent value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
