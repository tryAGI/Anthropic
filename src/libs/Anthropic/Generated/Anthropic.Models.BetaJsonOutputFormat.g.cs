...
namespace Anthropic
{
    ...
    public sealed partial class BetaJsonOutputFormat
    {
        ...
        /// <summary>
        /// Creates a new <see cref="BetaJsonOutputFormat"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static BetaJsonOutputFormat FromSchema(object schema)
        {
            return new BetaJsonOutputFormat
            {
                Schema = schema,
            };
        }
