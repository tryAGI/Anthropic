...
namespace Anthropic
{
    ...
    public sealed partial class BetaAnalyticsCostUsersResponse
    {
        ...
        public required global::System.Collections.Generic.IList<global::Anthropic.BetaAnalyticsCostUsersItem> Data { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BetaAnalyticsCostUsersResponse" /> class.
        /// </summary>
        /// <param name="data">
        /// Rows for this page, ranked by `order_by` in the `order` direction. One row per user, or several per user when `group_by[]` or `bucket_width` breaks that user's usage or cost out across rows. Rows split out by `cost_type` or `token_type` (cost endpoint only) stay adjacent and are ranked as one unit.
        /// </param>
...
#endif
        public BetaAnalyticsCostUsersResponse(
            global::System.Collections.Generic.IList<global::Anthropic.BetaAnalyticsCostUsersItem> data,
            bool hasMore,
