...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        {
            var __response = await BetaGetFileMetadataV1FilesFileIdGetAsResponseAsync(
                fileId: fileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaFileMetadataSchema>> BetaGetFileMetadataV1FilesFileIdGetAsResponseAsync(
            string fileId,
            string? anthropicBeta = default,
            string? anthropicVersion = default,
            string? xApiKey = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaGetFileMetadataV1FilesFileIdGet",
                                methodName: "BetaGetFileMetadataV1FilesFileIdGetAsync",
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaFileMetadataSchema.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaFileMetadataSchema>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaFileMetadataSchema.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
