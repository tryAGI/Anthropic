                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Anthropic.BetaManagedAgentsDeletedSession.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Anthropic.BetaManagedAgentsDeletedSession.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
