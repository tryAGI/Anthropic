...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? anthropicVersion,
            global::Anthropic.BetaComplianceSettingsUpdateParams request);
        partial void PrepareBetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? anthropicVersion,
            global::Anthropic.BetaComplianceSettingsUpdateParams request);
        partial void ProcessBetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaComplianceSettings> BetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostAsync(
        ...
        {
            var __response = await BetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaComplianceSettings>> BetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostArguments(
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPost",
                                methodName: "BetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostAsync",
                                pathTemplate: "\"/v1/organizations/compliance_settings?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaComplianceSettings.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaComplianceSettings>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaComplianceSettings.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaComplianceSettings> BetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaComplianceSettingsUpdateParams
            {
                State = state,
            };

            return await BetaUpdateComplianceSettingsV1OrganizationsComplianceSettingsPostAsync(
                anthropicVersion: anthropicVersion,
                request: __request,
                requestOptions: requestOptions,
