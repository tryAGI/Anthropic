...
{
    /// <inheritdoc />
    public class Caller2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.Caller2>
    {
        /// <inheritdoc />
        public override global::Anthropic.Caller2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaRequestToolUseBlockCallerDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaRequestToolUseBlockCallerDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaRequestToolUseBlockCallerDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.BetaDirectCaller? direct = default;
            if (discriminator?.Type == global::Anthropic.BetaRequestToolUseBlockCallerDiscriminatorType.Direct)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaRequestToolUseBlockCallerDiscriminatorType.CodeExecution20250825)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaRequestToolUseBlockCallerDiscriminatorType.CodeExecution20260120)
            {
            ...
            var __value = new global::Anthropic.Caller2(
                discriminator?.Type,
                direct,
        ...
        public override void Write(
            ...
            global::Anthropic.Caller2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
