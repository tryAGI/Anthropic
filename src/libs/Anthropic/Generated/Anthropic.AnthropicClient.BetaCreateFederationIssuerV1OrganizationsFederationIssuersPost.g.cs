...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        partial void ProcessBetaCreateFederationIssuerV1OrganizationsFederationIssuersPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await BetaCreateFederationIssuerV1OrganizationsFederationIssuersPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaCreateFederationIssuerV1OrganizationsFederationIssuersPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaCreateFederationIssuerV1OrganizationsFederationIssuersPost",
                                methodName: "BetaCreateFederationIssuerV1OrganizationsFederationIssuersPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaCreateFederationIssuerV1OrganizationsFederationIssuersPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaCreateFederationIssuerV1OrganizationsFederationIssuersPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaFederationIssuer> BetaCreateFederationIssuerV1OrganizationsFederationIssuersPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaFederationIssuerCreateParams
            {
                CheckJti = checkJti,
                IssuerUrl = issuerUrl,
                Jwks = jwks,
            ...
            return await BetaCreateFederationIssuerV1OrganizationsFederationIssuersPostAsync(
                anthropicBeta: anthropicBeta,
                anthropicVersion: anthropicVersion,
                request: __request,
                requestOptions: requestOptions,
