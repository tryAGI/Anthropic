...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaGetOrgRateLimitsV1OrganizationsRateLimitsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? model,
            ref global::Anthropic.BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetGroupType2? groupType,
            int? limit,
            ref string? page,
            ref string? xApiKey,
            ref string? anthropicVersion);
        partial void PrepareBetaGetOrgRateLimitsV1OrganizationsRateLimitsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? model,
            global::Anthropic.BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetGroupType2? groupType,
            int? limit,
            string? page,
            string? xApiKey,
            string? anthropicVersion);
        partial void ProcessBetaGetOrgRateLimitsV1OrganizationsRateLimitsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaGetOrgRateLimitsV1OrganizationsRateLimitsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaRateLimitListResponse> BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetAsync(
        ...
        {
            var __response = await BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetAsResponseAsync(
                model: model,
                groupType: groupType,
                limit: limit,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaRateLimitListResponse>> BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetAsResponseAsync(
            string? model = default,
            global::Anthropic.BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetGroupType2? groupType = default,
            int? limit = default,
            string? page = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaGetOrgRateLimitsV1OrganizationsRateLimitsGetArguments(
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaGetOrgRateLimitsV1OrganizationsRateLimitsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaGetOrgRateLimitsV1OrganizationsRateLimitsGet",
                                methodName: "BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetAsync",
                                pathTemplate: "\"/v1/organizations/rate_limits?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaGetOrgRateLimitsV1OrganizationsRateLimitsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaGetOrgRateLimitsV1OrganizationsRateLimitsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaRateLimitListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaRateLimitListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaRateLimitListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.BetaRateLimit> BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetAutoPagingAsync(
              string? model = default,
            global::Anthropic.BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetGroupType2? groupType = default,
            int? limit = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.BetaRateLimitListResponse, global::Anthropic.BetaRateLimit>(
                fetchPage: (__cursor, __ct) => BetaGetOrgRateLimitsV1OrganizationsRateLimitsGetAsync(
                    model: model,
                    groupType: groupType,
                    limit: limit,
                    page: __cursor,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.BetaRateLimit>?)__response.Data,
