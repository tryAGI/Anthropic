...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetArguments(
        ...
        partial void PrepareBetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessBetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaSelfHostedWork> BetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetAsync(
            string environmentId,
            int? blockMs = default,
        ...
        {
            var __response = await BetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaSelfHostedWork>> BetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetAsResponseAsync(
            string environmentId,
            int? blockMs = default,
            int? reclaimOlderThanMs = default,
            string? anthropicBeta = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/environments/{environmentId}/work/poll?beta=true",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("block_ms", blockMs?.ToString())
                                .AddOptionalParameter("reclaim_older_than_ms", reclaimOlderThanMs?.ToString())
                                ;
            ...
            if (anthropicWorkerId != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("Anthropic-Worker-ID", anthropicWorkerId.ToString());
            }
            if (authorization != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGet",
                                methodName: "BetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetAsync",
                                pathTemplate: "$\"/v1/environments/{environmentId}/work/poll?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaPollWorkV1EnvironmentsEnvironmentIdWorkPollGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
