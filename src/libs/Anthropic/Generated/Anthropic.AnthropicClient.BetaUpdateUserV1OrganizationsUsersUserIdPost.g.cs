...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaUpdateUserV1OrganizationsUsersUserIdPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userId,
            ref string? anthropicVersion,
            global::Anthropic.BetaUpdateUserParams request);
        partial void PrepareBetaUpdateUserV1OrganizationsUsersUserIdPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userId,
            string? anthropicVersion,
            global::Anthropic.BetaUpdateUserParams request);
        partial void ProcessBetaUpdateUserV1OrganizationsUsersUserIdPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaUpdateUserV1OrganizationsUsersUserIdPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaUser> BetaUpdateUserV1OrganizationsUsersUserIdPostAsync(
            string userId,
        ...
        {
            var __response = await BetaUpdateUserV1OrganizationsUsersUserIdPostAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaUser>> BetaUpdateUserV1OrganizationsUsersUserIdPostAsResponseAsync(
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBetaUpdateUserV1OrganizationsUsersUserIdPostArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/organizations/users/{userId}?beta=true",
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaUpdateUserV1OrganizationsUsersUserIdPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaUpdateUserV1OrganizationsUsersUserIdPost",
                                methodName: "BetaUpdateUserV1OrganizationsUsersUserIdPostAsync",
                                pathTemplate: "$\"/v1/organizations/users/{userId}?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateUserV1OrganizationsUsersUserIdPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateUserV1OrganizationsUsersUserIdPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaUser.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaUser>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaUser.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaUser> BetaUpdateUserV1OrganizationsUsersUserIdPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaUpdateUserParams
            {
                Role = role,
            };

            return await BetaUpdateUserV1OrganizationsUsersUserIdPostAsync(
                userId: userId,
                anthropicVersion: anthropicVersion,
                request: __request,
                requestOptions: requestOptions,
