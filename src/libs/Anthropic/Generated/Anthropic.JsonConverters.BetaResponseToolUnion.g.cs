...
{
    /// <inheritdoc />
    public class BetaResponseToolUnionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.BetaResponseToolUnion>
    {
        /// <inheritdoc />
        public override global::Anthropic.BetaResponseToolUnion Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Anthropic.BetaResponseTool? responseTool = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaResponseTool), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaResponseTool> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Anthropic.BetaResponseTool).Name}");
                        responseTool = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            var __value = new global::Anthropic.BetaResponseToolUnion(
                responseTool,
        ...
        public override void Write(
            ...
            global::Anthropic.BetaResponseToolUnion value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsResponseTool)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaResponseTool), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaResponseTool?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Anthropic.BetaResponseTool).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ResponseTool!, typeInfo);
            }
