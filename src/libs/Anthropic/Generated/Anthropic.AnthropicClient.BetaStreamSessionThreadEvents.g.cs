...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaStreamSessionThreadEventsArguments(
        ...
        partial void PrepareBetaStreamSessionThreadEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string threadId,
            global::System.Collections.Generic.IList<global::Anthropic.BetaManagedAgentsEventDeltaType>? eventDeltas);
        partial void ProcessBetaStreamSessionThreadEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaStreamSessionThreadEventsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaManagedAgentsStreamSessionThreadEvents> BetaStreamSessionThreadEventsAsync(
            string sessionId,
            string threadId,
        ...
        {
            var __response = await BetaStreamSessionThreadEventsAsResponseAsync(
                sessionId: sessionId,
                threadId: threadId,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaManagedAgentsStreamSessionThreadEvents>> BetaStreamSessionThreadEventsAsResponseAsync(
            string sessionId,
            string threadId,
            string? xApiKey = default,
            string? anthropicVersion = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaStreamSessionThreadEventsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/sessions/{sessionId}/threads/{threadId}/stream?beta=true",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("event_deltas[]", eventDeltas, selector: static x => x.ToValueString(), delimiter: ",", explode: true)
                                ;
            ...
            if (anthropicBeta != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaStreamSessionThreadEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaStreamSessionThreadEventsAsync",
                                pathTemplate: "$\"/v1/sessions/{sessionId}/threads/{threadId}/stream?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaStreamSessionThreadEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaStreamSessionThreadEventsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaManagedAgentsStreamSessionThreadEvents.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaManagedAgentsStreamSessionThreadEvents>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaManagedAgentsStreamSessionThreadEvents.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
