...
namespace Anthropic
{
    ...
    public sealed partial class BetaResponseTool
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Anthropic.BetaResponseToolInputSchema InputSchema { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BetaResponseTool" /> class.
        /// </summary>
        /// <param name="name">
        /// Name of the tool.<br/>
        /// This is how the tool will be called by the model and in `tool_use` blocks.
        ...
        public BetaResponseTool(
            string name,
            global::Anthropic.BetaResponseToolInputSchema inputSchema,
            string? type,
            string? description,
            bool? strict,
