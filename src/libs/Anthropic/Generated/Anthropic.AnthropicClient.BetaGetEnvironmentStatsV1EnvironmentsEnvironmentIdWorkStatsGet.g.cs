...
namespace Anthropic
{
    public partial class AnthropicClient
    {
        ...
        partial void PrepareBetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessBetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await BetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGetAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/environments/{environmentId}/work/stats?beta=true",
            ...
            if (authorization != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGet",
                                methodName: "BetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGetAsync",
                                pathTemplate: "$\"/v1/environments/{environmentId}/work/stats?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaGetEnvironmentStatsV1EnvironmentsEnvironmentIdWorkStatsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaSelfHostedWorkQueueStats.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaSelfHostedWorkQueueStats>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaSelfHostedWorkQueueStats.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
