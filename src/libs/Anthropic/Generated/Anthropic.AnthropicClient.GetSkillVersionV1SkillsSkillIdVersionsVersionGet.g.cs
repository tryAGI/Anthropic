...
namespace Anthropic
{
    ...
    {
        partial void PrepareGetSkillVersionV1SkillsSkillIdVersionsVersionGetArguments(
        ...
        partial void PrepareGetSkillVersionV1SkillsSkillIdVersionsVersionGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetSkillVersionV1SkillsSkillIdVersionsVersionGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSkillVersionV1SkillsSkillIdVersionsVersionGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.SkillVersion> GetSkillVersionV1SkillsSkillIdVersionsVersionGetAsync(
            string skillId,
            string version,
        ...
        {
            var __response = await GetSkillVersionV1SkillsSkillIdVersionsVersionGetAsResponseAsync(
                skillId: skillId,
                version: version,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.SkillVersion>> GetSkillVersionV1SkillsSkillIdVersionsVersionGetAsResponseAsync(
            string skillId,
            string version,
            string? anthropicVersion = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSkillVersionV1SkillsSkillIdVersionsVersionGetArguments(
            ...
            if (anthropicWorkspaceId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSkillVersionV1SkillsSkillIdVersionsVersionGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetSkillVersionV1SkillsSkillIdVersionsVersionGet",
                                methodName: "GetSkillVersionV1SkillsSkillIdVersionsVersionGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSkillVersionV1SkillsSkillIdVersionsVersionGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSkillVersionV1SkillsSkillIdVersionsVersionGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.SkillVersion.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.SkillVersion>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.SkillVersion.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
