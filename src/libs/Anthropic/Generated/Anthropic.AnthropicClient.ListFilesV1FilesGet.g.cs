...
namespace Anthropic
{
    ...
    {
        partial void PrepareListFilesV1FilesGetArguments(
        ...
        partial void PrepareListFilesV1FilesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessListFilesV1FilesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListFilesV1FilesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.FileListResponse> ListFilesV1FilesGetAsync(
            string? page = default,
        ...
        {
            var __response = await ListFilesV1FilesGetAsResponseAsync(
                page: page,
                ids: ids,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.FileListResponse>> ListFilesV1FilesGetAsResponseAsync(
            string? page = default,
            global::System.Collections.Generic.IList<string>? ids = default,
            int? limit = default,
            string? anthropicVersion = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListFilesV1FilesGetArguments(
            ...
            if (anthropicWorkspaceId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListFilesV1FilesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListFilesV1FilesGet",
                                methodName: "ListFilesV1FilesGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListFilesV1FilesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListFilesV1FilesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.FileListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.FileListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.FileListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.FileMetadataSchema> ListFilesV1FilesGetAutoPagingAsync(
              global::System.Collections.Generic.IList<string>? ids = default,
            int? limit = default,
            string? anthropicVersion = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.FileListResponse, global::Anthropic.FileMetadataSchema>(
                fetchPage: (__cursor, __ct) => ListFilesV1FilesGetAsync(
                    page: __cursor,
                    ids: ids,
                    limit: limit,
                    anthropicVersion: anthropicVersion,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.FileMetadataSchema>?)__response.Data,
