...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaListInvitesV1OrganizationsInvitesGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? beforeId,
            ref string? afterId,
            ref int? limit,
            global::System.Collections.Generic.IList<global::Anthropic.BetaListInvitesV1OrganizationsInvitesGetStatuse>? statuses,
            ref string? email,
            global::System.Collections.Generic.IList<string>? roles,
            ref string? xApiKey,
            ref string? anthropicVersion);
        partial void PrepareBetaListInvitesV1OrganizationsInvitesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessBetaListInvitesV1OrganizationsInvitesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaListInvitesV1OrganizationsInvitesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaListResponseInviteSchema> BetaListInvitesV1OrganizationsInvitesGetAsync(
            string? beforeId = default,
            string? afterId = default,
            int? limit = default,
            global::System.Collections.Generic.IList<global::Anthropic.BetaListInvitesV1OrganizationsInvitesGetStatuse>? statuses = default,
        ...
        {
            var __response = await BetaListInvitesV1OrganizationsInvitesGetAsResponseAsync(
                beforeId: beforeId,
                afterId: afterId,
                limit: limit,
                statuses: statuses,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaListResponseInviteSchema>> BetaListInvitesV1OrganizationsInvitesGetAsResponseAsync(
            string? beforeId = default,
            string? afterId = default,
            int? limit = default,
            global::System.Collections.Generic.IList<global::Anthropic.BetaListInvitesV1OrganizationsInvitesGetStatuse>? statuses = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaListInvitesV1OrganizationsInvitesGetArguments(
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaListInvitesV1OrganizationsInvitesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaListInvitesV1OrganizationsInvitesGet",
                                methodName: "BetaListInvitesV1OrganizationsInvitesGetAsync",
                                pathTemplate: "\"/v1/organizations/invites?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaListInvitesV1OrganizationsInvitesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaListInvitesV1OrganizationsInvitesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaListResponseInviteSchema.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaListResponseInviteSchema>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaListResponseInviteSchema.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps BetaListInvitesV1OrganizationsInvitesGetAsync as an IAsyncEnumerable&lt;global::Anthropic.BetaInviteSchema&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="beforeId">
        /// ID of the object to use as a cursor for pagination. When provided, returns the page of results immediately before this object.
        /// </param>
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.BetaInviteSchema> BetaListInvitesV1OrganizationsInvitesGetAutoPagingAsync(
              string? beforeId = default,
            int? limit = default,
            global::System.Collections.Generic.IList<global::Anthropic.BetaListInvitesV1OrganizationsInvitesGetStatuse>? statuses = default,
            string? email = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.BetaListResponseInviteSchema, global::Anthropic.BetaInviteSchema>(
                fetchPage: (__cursor, __ct) => BetaListInvitesV1OrganizationsInvitesGetAsync(
                    beforeId: beforeId,
                    afterId: __cursor,
                    limit: limit,
                    statuses: statuses,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.BetaInviteSchema>?)__response.Data,
