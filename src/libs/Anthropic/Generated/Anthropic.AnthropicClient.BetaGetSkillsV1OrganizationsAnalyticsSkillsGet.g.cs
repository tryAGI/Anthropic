...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaGetSkillsV1OrganizationsAnalyticsSkillsGetArguments(
            ...
            int? limit,
            ref string? page,
            global::System.Collections.Generic.IList<global::Anthropic.BetaGetSkillsV1OrganizationsAnalyticsSkillsGetGroupByVariant1Item>? groupBy,
            global::System.Collections.Generic.IList<string>? filter,
            ref string? orderBy,
            ref global::Anthropic.BetaGetSkillsV1OrganizationsAnalyticsSkillsGetOrder? order,
            ref string? anthropicVersion,
            ref string? xApiKey);
        partial void PrepareBetaGetSkillsV1OrganizationsAnalyticsSkillsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<string>? filter,
            string? orderBy,
            global::Anthropic.BetaGetSkillsV1OrganizationsAnalyticsSkillsGetOrder? order,
            string? anthropicVersion,
            string? xApiKey);
        partial void ProcessBetaGetSkillsV1OrganizationsAnalyticsSkillsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaGetSkillsV1OrganizationsAnalyticsSkillsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <summary>
        /// Get Skill Usage<br/>
        /// Get per-skill usage for a given day, with cursor-based pagination.<br/>
        /// Returns skill usage metrics for the organization, sorted by skill name.<br/>
        /// Use `group_by[]` to break usage out per member, per RBAC group, or per<br/>
        /// product surface, and `filter[]` to scope results; the parameter<br/>
        /// descriptions list the supported dimensions. Available to organizations<br/>
        /// on a Claude Enterprise plan. Requires an API key with the<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaAnalyticsSkillsResponse> BetaGetSkillsV1OrganizationsAnalyticsSkillsGetAsync(
            global::System.DateTime? date = default,
            global::System.DateTime? startingDate = default,
            global::System.DateTime? endingDate = default,
            int? limit = default,
            string? page = default,
            global::System.Collections.Generic.IList<global::Anthropic.BetaGetSkillsV1OrganizationsAnalyticsSkillsGetGroupByVariant1Item>? groupBy = default,
            global::System.Collections.Generic.IList<string>? filter = default,
            string? orderBy = default,
            global::Anthropic.BetaGetSkillsV1OrganizationsAnalyticsSkillsGetOrder? order = default,
            string? anthropicVersion = default,
            string? xApiKey = default,
            global::Anthropic.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await BetaGetSkillsV1OrganizationsAnalyticsSkillsGetAsResponseAsync(
                date: date,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaAnalyticsSkillsResponse>> BetaGetSkillsV1OrganizationsAnalyticsSkillsGetAsResponseAsync(
            global::System.DateTime? date = default,
            global::System.DateTime? startingDate = default,
            global::System.DateTime? endingDate = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaGetSkillsV1OrganizationsAnalyticsSkillsGetArguments(
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaGetSkillsV1OrganizationsAnalyticsSkillsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaGetSkillsV1OrganizationsAnalyticsSkillsGet",
                                methodName: "BetaGetSkillsV1OrganizationsAnalyticsSkillsGetAsync",
                                pathTemplate: "\"/v1/organizations/analytics/skills?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaGetSkillsV1OrganizationsAnalyticsSkillsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaGetSkillsV1OrganizationsAnalyticsSkillsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaAnalyticsSkillsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaAnalyticsSkillsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaAnalyticsSkillsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps BetaGetSkillsV1OrganizationsAnalyticsSkillsGetAsync as an IAsyncEnumerable&lt;global::Anthropic.BetaAnalyticsSkillActivity&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="date">
        /// UTC date in YYYY-MM-DD format. The day to get skill usage for. Data is typically available with a 1-day lag (varies by query; the error for a too-recent date names the latest available day) and may be revised by a few percent over the following days. No earlier than 2026-01-01.
        /// </param>
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.BetaAnalyticsSkillActivity> BetaGetSkillsV1OrganizationsAnalyticsSkillsGetAutoPagingAsync(
              global::System.DateTime? date = default,
            global::System.DateTime? startingDate = default,
            global::System.DateTime? endingDate = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.BetaAnalyticsSkillsResponse, global::Anthropic.BetaAnalyticsSkillActivity>(
                fetchPage: (__cursor, __ct) => BetaGetSkillsV1OrganizationsAnalyticsSkillsGetAsync(
                    date: date,
                    startingDate: startingDate,
                    endingDate: endingDate,
                    limit: limit,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.BetaAnalyticsSkillActivity>?)__response.Data,
