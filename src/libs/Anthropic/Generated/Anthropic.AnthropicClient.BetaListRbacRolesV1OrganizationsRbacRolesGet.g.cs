...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaListRbacRolesV1OrganizationsRbacRolesGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string? page,
            ref string? anthropicVersion,
            ref string? xApiKey);
        partial void PrepareBetaListRbacRolesV1OrganizationsRbacRolesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xApiKey);
        partial void ProcessBetaListRbacRolesV1OrganizationsRbacRolesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaListRbacRolesV1OrganizationsRbacRolesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <summary>
        /// List RBAC Roles<br/>
        /// List RBAC Roles in the organization.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaRbacRoleList> BetaListRbacRolesV1OrganizationsRbacRolesGetAsync(
            int? limit = default,
            string? page = default,
        ...
        {
            var __response = await BetaListRbacRolesV1OrganizationsRbacRolesGetAsResponseAsync(
                limit: limit,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaRbacRoleList>> BetaListRbacRolesV1OrganizationsRbacRolesGetAsResponseAsync(
            int? limit = default,
            string? page = default,
            string? anthropicVersion = default,
            string? xApiKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaListRbacRolesV1OrganizationsRbacRolesGetArguments(
            ...
            if (xApiKey != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaListRbacRolesV1OrganizationsRbacRolesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaListRbacRolesV1OrganizationsRbacRolesGet",
                                methodName: "BetaListRbacRolesV1OrganizationsRbacRolesGetAsync",
                                pathTemplate: "\"/v1/organizations/rbac_roles?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaListRbacRolesV1OrganizationsRbacRolesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaListRbacRolesV1OrganizationsRbacRolesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaRbacRoleList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaRbacRoleList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaRbacRoleList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        /// <summary>
        /// Wraps BetaListRbacRolesV1OrganizationsRbacRolesGetAsync as an IAsyncEnumerable&lt;global::Anthropic.BetaRbacRole&gt; that auto-pages over the response.
        /// </summary>
        /// <param name="limit">
        /// Number of items to return per page.<br/>
        /// Defaults to `20`. Ranges from `1` to `1000`.<br/>
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.BetaRbacRole> BetaListRbacRolesV1OrganizationsRbacRolesGetAutoPagingAsync(
              int? limit = default,
            string? anthropicVersion = default,
            string? xApiKey = default,
            string? page = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.BetaRbacRoleList, global::Anthropic.BetaRbacRole>(
                fetchPage: (__cursor, __ct) => BetaListRbacRolesV1OrganizationsRbacRolesGetAsync(
                    limit: limit,
                    page: __cursor,
                    anthropicVersion: anthropicVersion,
                    xApiKey: xApiKey,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.BetaRbacRole>?)__response.Data,
