...
{
    /// <inheritdoc />
    public class Scope4JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.Scope4>
    {
        /// <inheritdoc />
        public override global::Anthropic.Scope4 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaSpendSummaryScopeDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaSpendSummaryScopeDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaSpendSummaryScopeDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.BetaUserScope? user = default;
            if (discriminator?.Type == global::Anthropic.BetaSpendSummaryScopeDiscriminatorType.User)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaSpendSummaryScopeDiscriminatorType.SeatTier)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaSpendSummaryScopeDiscriminatorType.RbacGroup)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaSpendSummaryScopeDiscriminatorType.OrganizationService)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaSpendSummaryScopeDiscriminatorType.Organization)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaSpendSummaryScopeDiscriminatorType.Workspace)
            {
            ...
            var __value = new global::Anthropic.Scope4(
                discriminator?.Type,
                user,
