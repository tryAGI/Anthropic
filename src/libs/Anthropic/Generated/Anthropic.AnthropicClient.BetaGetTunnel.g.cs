...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaGetTunnelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xApiKey,
            ref string? anthropicVersion,
            ref string? anthropicBeta,
            ref string tunnelId);
        partial void PrepareBetaGetTunnelRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string tunnelId);
        partial void ProcessBetaGetTunnelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaGetTunnelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaTunnel> BetaGetTunnelAsync(
            string tunnelId,
        ...
        {
            var __response = await BetaGetTunnelAsResponseAsync(
                tunnelId: tunnelId,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaTunnel>> BetaGetTunnelAsResponseAsync(
            string tunnelId,
            string? xApiKey = default,
            string? anthropicVersion = default,
            string? anthropicBeta = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/tunnels/{tunnelId}?beta=true",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaGetTunnelAsync",
                                pathTemplate: "$\"/v1/tunnels/{tunnelId}?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaGetTunnelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaTunnel.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaTunnel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaTunnel.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
