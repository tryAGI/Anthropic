...
{
    /// <inheritdoc />
    public class ServerToolResults2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.ServerToolResults2>
    {
        /// <inheritdoc />
        public override global::Anthropic.ServerToolResults2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.WebFetchUrlSourcesServerToolResultsDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.WebFetchUrlSourcesServerToolResultsDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.WebFetchUrlSourcesServerToolResultsDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.WebFetchUrlSourceAll? all = default;
            if (discriminator?.Type == global::Anthropic.WebFetchUrlSourcesServerToolResultsDiscriminatorType.All)
            {
            ...
            if (discriminator?.Type == global::Anthropic.WebFetchUrlSourcesServerToolResultsDiscriminatorType.None)
            {
            ...
            if (discriminator?.Type == global::Anthropic.WebFetchUrlSourcesServerToolResultsDiscriminatorType.Only)
            {
            ...
            if (discriminator?.Type == global::Anthropic.WebFetchUrlSourcesServerToolResultsDiscriminatorType.Except)
            {
            ...
            var __value = new global::Anthropic.ServerToolResults2(
                discriminator?.Type,
                all,
        ...
        public override void Write(
            ...
            global::Anthropic.ServerToolResults2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
