...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaListExternalKeysV1OrganizationsExternalKeysGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string? page,
            ref string? xApiKey,
            ref string? anthropicVersion);
        partial void PrepareBetaListExternalKeysV1OrganizationsExternalKeysGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessBetaListExternalKeysV1OrganizationsExternalKeysGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaListExternalKeysV1OrganizationsExternalKeysGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaExternalKeyListResponse> BetaListExternalKeysV1OrganizationsExternalKeysGetAsync(
            int? limit = default,
            string? page = default,
        ...
        {
            var __response = await BetaListExternalKeysV1OrganizationsExternalKeysGetAsResponseAsync(
                limit: limit,
                page: page,
                xApiKey: xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaExternalKeyListResponse>> BetaListExternalKeysV1OrganizationsExternalKeysGetAsResponseAsync(
            int? limit = default,
            string? page = default,
            string? xApiKey = default,
            string? anthropicVersion = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBetaListExternalKeysV1OrganizationsExternalKeysGetArguments(
            ...
            if (anthropicVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaListExternalKeysV1OrganizationsExternalKeysGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaListExternalKeysV1OrganizationsExternalKeysGet",
                                methodName: "BetaListExternalKeysV1OrganizationsExternalKeysGetAsync",
                                pathTemplate: "\"/v1/organizations/external_keys?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaListExternalKeysV1OrganizationsExternalKeysGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaListExternalKeysV1OrganizationsExternalKeysGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaExternalKeyListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaExternalKeyListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaExternalKeyListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public global::System.Collections.Generic.IAsyncEnumerable<global::Anthropic.BetaExternalKey> BetaListExternalKeysV1OrganizationsExternalKeysGetAutoPagingAsync(
              int? limit = default,
            string? xApiKey = default,
            string? anthropicVersion = default,
            string? page = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return global::Anthropic.AutoSDKPager.CursorAsync<global::Anthropic.BetaExternalKeyListResponse, global::Anthropic.BetaExternalKey>(
                fetchPage: (__cursor, __ct) => BetaListExternalKeysV1OrganizationsExternalKeysGetAsync(
                    limit: limit,
                    page: __cursor,
                    xApiKey: xApiKey,
                    anthropicVersion: anthropicVersion,
                ...
                extractItems: static __response => __response is null
                    ? null
                    : (global::System.Collections.Generic.IEnumerable<global::Anthropic.BetaExternalKey>?)__response.Data,
