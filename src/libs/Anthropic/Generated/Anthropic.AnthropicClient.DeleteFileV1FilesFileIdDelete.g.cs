...
namespace Anthropic
{
    ...
    {
        partial void PrepareDeleteFileV1FilesFileIdDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string fileId,
            ref string? anthropicVersion,
            ref string? xApiKey,
            ref string? anthropicWorkspaceId);
        partial void PrepareDeleteFileV1FilesFileIdDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessDeleteFileV1FilesFileIdDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteFileV1FilesFileIdDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.FileDeleteResponse> DeleteFileV1FilesFileIdDeleteAsync(
            string fileId,
        ...
        {
            var __response = await DeleteFileV1FilesFileIdDeleteAsResponseAsync(
                fileId: fileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.FileDeleteResponse>> DeleteFileV1FilesFileIdDeleteAsResponseAsync(
            string fileId,
            string? anthropicVersion = default,
            string? xApiKey = default,
            string? anthropicWorkspaceId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteFileV1FilesFileIdDeleteArguments(
            ...
            if (anthropicWorkspaceId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteFileV1FilesFileIdDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteFileV1FilesFileIdDelete",
                                methodName: "DeleteFileV1FilesFileIdDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteFileV1FilesFileIdDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteFileV1FilesFileIdDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.FileDeleteResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.FileDeleteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.FileDeleteResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
