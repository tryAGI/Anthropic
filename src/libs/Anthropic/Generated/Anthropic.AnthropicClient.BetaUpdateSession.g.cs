...
namespace Anthropic
{
    ...
    {
        partial void PrepareBetaUpdateSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? anthropicVersion,
            ref string? anthropicBeta,
            ref string sessionId,
            global::Anthropic.BetaManagedAgentsUpdateSessionParams request);
        partial void PrepareBetaUpdateSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string sessionId,
            global::Anthropic.BetaManagedAgentsUpdateSessionParams request);
        partial void ProcessBetaUpdateSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBetaUpdateSessionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaManagedAgentsSession> BetaUpdateSessionAsync(
            string sessionId,
        ...
        {
            var __response = await BetaUpdateSessionAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Anthropic.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaManagedAgentsSession>> BetaUpdateSessionAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBetaUpdateSessionArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Anthropic.PathBuilder(
                                path: $"/v1/sessions/{sessionId}?beta=true",
            ...
            if (anthropicBeta != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareBetaUpdateSessionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Anthropic.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "BetaUpdateSessionAsync",
                                pathTemplate: "$\"/v1/sessions/{sessionId}?beta=true\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessBetaUpdateSessionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Anthropic.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBetaUpdateSessionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Anthropic.BetaManagedAgentsSession.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Anthropic.AutoSDKHttpResponse<global::Anthropic.BetaManagedAgentsSession>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Anthropic.BetaManagedAgentsSession.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Anthropic.BetaManagedAgentsSession> BetaUpdateSessionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Anthropic.BetaManagedAgentsUpdateSessionParams
            {
                Title = title,
                Metadata = metadata,
                VaultIds = vaultIds,
