...
{
    /// <inheritdoc />
    public class ClientToolResultsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Anthropic.ClientToolResults>
    {
        /// <inheritdoc />
        public override global::Anthropic.ClientToolResults Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Anthropic.BetaWebFetchUrlSourcesClientToolResultsDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Anthropic.BetaWebFetchUrlSourcesClientToolResultsDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Anthropic.BetaWebFetchUrlSourcesClientToolResultsDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Anthropic.BetaWebFetchUrlSourceAll? all = default;
            if (discriminator?.Type == global::Anthropic.BetaWebFetchUrlSourcesClientToolResultsDiscriminatorType.All)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaWebFetchUrlSourcesClientToolResultsDiscriminatorType.None)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaWebFetchUrlSourcesClientToolResultsDiscriminatorType.Only)
            {
            ...
            if (discriminator?.Type == global::Anthropic.BetaWebFetchUrlSourcesClientToolResultsDiscriminatorType.Except)
            {
            ...
            var __value = new global::Anthropic.ClientToolResults(
                discriminator?.Type,
                all,
        ...
        public override void Write(
            ...
            global::Anthropic.ClientToolResults value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
