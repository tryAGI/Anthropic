...
namespace Anthropic
{
    ...
    public sealed partial class BetaAnalyticsCostReportTimeBucket
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Anthropic.BetaAnalyticsCostBucketedResult> Results { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BetaAnalyticsCostReportTimeBucket" /> class.
        /// </summary>
        /// <param name="endingAt">
        /// End of the time bucket (exclusive) in RFC 3339 format.
        /// </param>
        ...
        public BetaAnalyticsCostReportTimeBucket(
            ...
            global::System.Collections.Generic.IList<global::Anthropic.BetaAnalyticsCostBucketedResult> results,
