...
namespace Anthropic
{
    ...
    public sealed partial class BetaRequestMCPToolResultBlock
    {
        ...
        /// <summary>
        /// Creates a new <see cref="BetaRequestMCPToolResultBlock"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static BetaRequestMCPToolResultBlock FromToolUseId(string toolUseId)
        {
            return new BetaRequestMCPToolResultBlock
            {
                ToolUseId = toolUseId,
            };
        }
