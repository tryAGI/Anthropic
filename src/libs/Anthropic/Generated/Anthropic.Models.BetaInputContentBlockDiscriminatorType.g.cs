...
namespace Anthropic
{
    ...
    public static class BetaInputContentBlockDiscriminatorTypeExtensions
    {
        ...
        public static string ToValueString(this BetaInputContentBlockDiscriminatorType value)
        {
            return value switch
            {
                BetaInputContentBlockDiscriminatorType.AdvisorToolResult => "advisor_tool_result",
                ...
                BetaInputContentBlockDiscriminatorType.McpToolListing => "mcp_tool_listing",
        ...
        public static BetaInputContentBlockDiscriminatorType? ToEnum(string value)
        {
            return value switch
            {
                "advisor_tool_result" => BetaInputContentBlockDiscriminatorType.AdvisorToolResult,
                ...
                "mcp_tool_listing" => BetaInputContentBlockDiscriminatorType.McpToolListing,
